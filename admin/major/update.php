<?php
    is_array($major) ? extract($major) : null;
?>
            ...
            <div class="row align-items-center">
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        <h3 class="page-title">Chỉnh sửa ngành học</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card comman-shadow">
                    <div class="card-body">
                        <form action="index.php?act=update_major" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                            <div class="row">
                                <div class="col-12">
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group local-forms">
                                        ...
                                        <input class="form-control" name="name" type="text" value="<?= $name ?>" placeholder="Điền tên ngành học...">
                                    </div>
                                </div>
                                <div class="col-12">
