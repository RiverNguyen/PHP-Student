            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-sub-header">
                        <h3 class="page-title">Danh sách ngành học</h3>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                <div class="col">
                                    <h3 class="page-title">Ngành học</h3>
                                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="actions justify-content-start">
                                                    <a href="<?= $deltailMajor ?>" class="btn btn-sm bg-success-light me-2">
                                                        <i class="feather-eye"></i>
                                                    </a>
                                                    <a href="<?= $editMajor ?>" class="btn btn-sm bg-danger-light me-2">
                                                        <i class="feather-edit"></i>
                                                    </a>
                                                    <a href="<?= $delMajor ?>" class="btn btn-sm bg-danger-light delete-major" data-major-id="<?= $id ?>">
