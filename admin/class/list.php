                            ...
                            <table id="example" class="table border-0 star-student table-hover table-center mb-0 table-striped">
                                ...
                                <tbody>
                                    <?php foreach ($classList as $class) : ?>
                                        <?php
                                        extract($class);
                                        $editClass = "index.php?act=edit_class&id=" . $id;
                                        $delClass = "index.php?act=del_class&id=" . $id;
                                        $deltailClass = "index.php?act=class_detail&id=" . $id;
                                        ?>
                                        <tr>
                                            <td>
                                                <div class="form-check check-tables">
                                            ...
                                            <td>
                                                <div class="actions justify-content-start">
                                                    <a href="<?= $deltailClass ?>" class="btn btn-sm bg-success-light me-2">
                                                        <i class="feather-eye"></i>
                                                    </a>
                                                    <a href="<?= $editClass ?>" class="btn btn-sm bg-danger-light me-2">
                                                        <i class="feather-edit"></i>
                                                    </a>
                                                    <a href="<?= $delClass ?>" class="btn btn-sm bg-danger-light delete-class" data-class-id="<?= $id ?>">
