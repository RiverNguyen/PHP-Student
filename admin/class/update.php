        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card comman-shadow">
                    <div class="card-body">
                        <form action="index.php?act=update_class" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-12">
                                ...
                                <div class="col-12 col-sm-7">
                                    <div class="form-group local-forms">
                                        <label>Học sinh <span class="login-danger">*</span></label>
                                        <select class="form-control select" name="students[]" multiple>
                                ...
                                <div class="col-12">
                                    <div class="student-submit">
                                        ...
                                        <a href="index.php?act=change_name_class&id=<?= $_GET['id'] ?>"><input type="button" name="save" class="btn btn-primary" value="Sửa tên lớp"></input></a>
                                    </div>
                                    <br>
