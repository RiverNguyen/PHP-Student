        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="card comman-shadow">
                    <div class="card-body">
                        <form action="index.php?act=add_stu" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
                            <div class="row">
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <div class="student-submit">
                                        ...
                                        <a href="index.php?act=list_stu"><input type="button" name="save" class="btn btn-primary" value="Danh sách"></input></a>
                                    </div>
                                    <br>
...
<script>
    function validateForm() {
        ...
        if (dob >= currentDate || dob >= maxDate) {
            alert("Ngày sinh không hợp lệ. Sinh viên phải đủ 18 tuổi trở lên và năm sinh không được nhỏ hơn 1980.");
            return false;
        }

        if (dob.getFullYear() < 1980) {
            alert("Năm sinh không được nhỏ hơn 1980.");
            return false;
        }
