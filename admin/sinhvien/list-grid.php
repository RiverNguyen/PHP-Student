                        ...
                        <div class="page-header">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto text-end float-end ms-auto download-grp">
                                    <a href="index.php?act=list_stu" class="btn btn-outline-gray me-2"><i class="feather-list"></i></a>
                                    <a href="#" class="btn btn-outline-gray me-2 active"><i class="feather-grid "></i></a>
                                            ...
                                            <div class="card-body">
                                                <div class="student-box flex-fill">
                                                    ...
                                                    <div class="student-content pb-0">
                                                        <h5><a href="<?= $deltailStu ?>"><?= $name ?></a></h5>
                                                        <h6>Student</h6>
                                                    </div>
                                                </div>
                                            </div>
